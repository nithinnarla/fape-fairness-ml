"""
FAPE, FairGround Corpus Fairness Intervention: ThresholdOptimizer
...
def run_stage2():
    print("FAPE Phase 4, FairGround Fairness Intervention: ThresholdOptimizer")
    print("=" * 56)
    ...
    print(f"\n--- FairGround intervention complete ---")
