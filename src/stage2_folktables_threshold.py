"""
FAPE, Folktables ACS Fairness Intervention: ThresholdOptimizer
...
def run_stage2():
    print("FAPE Phase 4, Folktables ACS Fairness Intervention: ThresholdOptimizer")
    print("=" * 58)
    ...
    print(f"\n--- Folktables intervention complete ---")
